  ...
  "mt-4 px-4 py-3 mx-4 bg-white dark:bg-gray-800 rounded-full shadow-lg flex items-center gap-2.5 min-w-[200px] max-w-[280px] sm:max-w-[320px] border border-gray-200 dark:border-gray-700 backdrop-blur-sm pointer-events-auto transform transition-all duration-500 ease-out data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700",
        success: "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700",
        warning: "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "hidden", // Hide close button for iOS style
      className
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-medium text-gray-900 dark:text-white", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-xs text-gray-600 dark:text-gray-400 mt-0.5", className)}
    {...props}
  />
))
